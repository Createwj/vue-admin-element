<template>
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="listQuery.type" placeholder="比赛级别" clearable class="filter-item" style="width: 130px">
    ...
    >
      ...
      <el-table-column label="参与量" width="80px">
        <template slot-scope="{row}">
...
const calendarTypeOptions = [
  { key: '1', display_name: '初级' },
  { key: '2', display_name: '中级' },
  { key: '3', display_name: '高级' },
  { key: '4', display_name: '专业' }
]
